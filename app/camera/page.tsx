...
export default function CameraVision() {
  ...
  // Simulate camera feed and detection
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      if (Math.random() < 0.4) {
        ...
        setDetectedCubes((prev) => [newCube, ...prev.slice(0, 9)])
      }
    }, 2000)
        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent>
            <div className="relative bg-gray-900 rounded-lg h-80 overflow-hidden">
              ...
              <div className="absolute bottom-8 left-4 right-4 h-16 bg-gray-700 rounded opacity-60"></div>
              ...
              {showBoundingBoxes &&
                detectedCubes.slice(0, 3).map((cube, index) => (
                  <div
                    key={cube.id}
                  ...
                  >
                    <div className="w-full h-full rounded" style={{ backgroundColor: getCubeColor(cube.color) }}></div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3 max-h-80 overflow-y-auto">
              {detectedCubes.map((cube) => (
                <div key={cube.id} className="flex items-center justify-between p-2 bg-gray-50 rounded">
                  <div className="flex items-center gap-2">
          ...
          <CardContent className="space-y-6">
            <div>
              ...
              <Slider
                ...
                onValueChange={(value) => setVisionParams((prev) => ({ ...prev, brightness: value[0] }))}
                max={100}
                min={0}
                step={1}
                className="w-full mt-2"
              />
              <div className="text-xs text-muted-foreground mt-1">{visionParams.brightness}%</div>
            </div>
            ...
            <div>
              ...
              <Slider
                ...
                onValueChange={(value) => setVisionParams((prev) => ({ ...prev, contrast: value[0] }))}
                max={100}
                min={0}
                step={1}
                className="w-full mt-2"
              />
              <div className="text-xs text-muted-foreground mt-1">{visionParams.contrast}%</div>
            </div>
            ...
            <div>
              ...
              <Slider
                ...
                onValueChange={(value) => setVisionParams((prev) => ({ ...prev, saturation: value[0] }))}
                max={100}
                min={0}
                step={1}
                className="w-full mt-2"
              />
              <div className="text-xs text-muted-foreground mt-1">{visionParams.saturation}%</div>
            </div>
            ...
            <div className="space-y-4 pt-4 border-t">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch id="bounding-boxes" checked={showBoundingBoxes} onCheckedChange={setShowBoundingBoxes} />
              </div>
            </div>
          </CardContent>
        </Card>
