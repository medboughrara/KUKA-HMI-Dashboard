...
export default function ProcessFlow() {
  ...
  const colors = ["red", "yellow", "green", "defected"]

  useEffect(() => {
    if (!isAnimating) return

    const interval = setInterval(() => {
      // Add new cubes at CAP3
      if (Math.random() < 0.3) {
        ...
        <Card className="lg:col-span-3">
          ...
          <CardContent>
            <div className="relative bg-gray-50 rounded-lg h-96 overflow-hidden">
              ...
              <div className="absolute bottom-20 left-16 w-80 h-16 bg-yellow-200 rounded flex items-center justify-center border-2 border-yellow-300">
              ...
              <div className="absolute left-16 top-16 w-16 h-48 bg-yellow-200 rounded flex items-center justify-center border-2 border-yellow-300">
              ...
              {/* KUKA Robot */}
              <div
                className="absolute w-20 h-20 bg-orange-200 rounded border-4 border-orange-400 flex items-center justify-center transition-all duration-300"
              ...
              <div className="absolute bottom-40 left-20 flex gap-4">
                ...
                <div className="w-12 h-12 bg-yellow-300 rounded border-2 border-yellow-400 flex items-center justify-center">
